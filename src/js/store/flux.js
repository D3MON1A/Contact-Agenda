		...
		actions: {
			addContacts: (name, address, number, email) => {
				fetch("https://assets.breatheco.de/apis/fake/contact/", {
					...
					.then(res => res.json())
					.then(() => {
						fetch("https://assets.breatheco.de/apis/fake/contact/agenda/leisyarcia")
							.then(red => red.json())
			...
			deleteContacts: indexDel => {
				...
				fetch(`https://assets.breatheco.de/apis/fake/contact/${indexDel}`, {
					...
					.then(res => res.json())
					.then(() => {
						fetch("https://assets.breatheco.de/apis/fake/contact/agenda/juancastro")
							.then(red => red.json())
							.then(data => setStore({ allContacts: data }));
					});
			},
